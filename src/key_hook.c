...
/*   Updated: 2024/03/07 19:50:33 by fwatanab         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void movement_player(t_vars *vars, char direction)
{
	if (direction == 'w')
	{
		if(vars->conf->map[(int)(vars->player->pos_y + vars->player->dir_y * MOVESPEED)][(int)(vars->player->pos_x + vars->player->dir_x * MOVESPEED)] == '0')
		{
	...
	{
		if(vars->conf->map[(int)(vars->player->pos_y - vars->player->dir_x * MOVESPEED)][(int)(vars->player->pos_x + vars->player->dir_y * MOVESPEED)] == '0')
		{
